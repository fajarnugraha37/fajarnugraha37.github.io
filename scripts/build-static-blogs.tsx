...
async function renderDocument({
  ...
  const contentHtml = `${renderToStaticMarkup(children)}${getMermaidEnhancerScript()}${getCodeBlockEnhancerScript()}`;
  ...
  if (shellOutputRoot) {
    return renderStaticAppShellDocument({
      ...
      description,
      contentHtml,
      headHtml: `<style>${getMermaidEnhancerStyles()}${getCodeBlockEnhancerStyles()}</style>`,
    });
  }
